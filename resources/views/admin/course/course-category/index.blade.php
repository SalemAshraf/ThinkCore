                        ...
                        <table class="table table-vcenter card-table">
                            ...
                            <tbody>
                                @forelse ($categories as $category)
                                    <tr>
                                        <td><img style="width: 50px;" src="{{ asset($category->icon) }}"
                                        ...
                                        <td>
                                            <a href="{{ route('admin.course-sub-categories.index', $category->id) }}"
                                                class="btn btn-secondary"> <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                            ...
                                            <!-- زر لفتح المودال وتمرير ID الفئة -->
        ...
        <div class="modal-dialog modal-sm modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body text-center py-4">
                    ...
                    <p id="deleteCategoryName" class="text-danger fw-bold mt-1"></p>
                </div>
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            deleteButtons.forEach(button => {
                button.addEventListener('click', function () {
                    ...
                    // تحديث اسم الفئة للعرض داخل المودال
                    deleteCategoryName.textContent = `Category: ${categoryName}`;

                    // تعيين مسار الفورم
                    deleteForm.setAttribute('action', `/admin/course-categories/${categoryId}`);
                });
            });
        });
    </script>

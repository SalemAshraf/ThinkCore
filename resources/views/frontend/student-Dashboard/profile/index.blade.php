...
@section('content')
    ...
    <section class="wsus__dashboard mt_90 xs_mt_70 pb_120 xs_pb_100">
        <div class="container">
            <div class="row">
                @include('frontend.student-Dashboard.sidebar', ['active' => 'profile'])
                <div class="col-xl-9 col-md-8 wow fadeInRight" style="visibility: visible; animation-name: fadeInRight;">
                    <div class="wsus__dashboard_contant">
                        ...
                        <form method="POST" action="{{ route('student.profile.update') }}" enctype="multipart/form-data" class="wsus__dashboard_profile_update">
                            @csrf
                    ...
                    <div class="wsus__dashboard_contant">
                        ...
                        <form method="POST" action="{{ route('student.profile.social.update') }}"
                            class="wsus__dashboard_profile_update">
                            @csrf
                            <div class="row">
                                <div class="col-xl-12">
